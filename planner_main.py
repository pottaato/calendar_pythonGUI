...
print("""
        ...
        <script language='javascript'>
            function alter(eid) {location.href = 'planner_copy9.py?alter=' + eid;}
            function back() {location.href = 'planner_copy9.py';}
        </script>
        <body>
        <form action='/cgi-bin/planner_copy9.py' method='GET'>""")
